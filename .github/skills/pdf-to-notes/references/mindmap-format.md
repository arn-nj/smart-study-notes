...
5. For each chapter/section node, include this exact Level 2 schema in this order: `Concept Deep Dive`, `Worked Example`, `Demo Walkthrough`, `Advanced Scenario`, `Trade-offs`
...
| Level | Content |
|-------|---------|
| 0 | Root Title (e.g., book name, course name, document title) |
| 1 | Major sections (chapters, modules, or sections) |
