...
def build_xmind(mm_path, out_path):
    ...
    meta_xml = b'<?xml version="1.0" encoding="UTF-8"?>\n<xmap-meta xmlns="urn:xmind:xmap:xmlns:meta:2.0"><creator>transcript-to-notes</creator></xmap-meta>'
...
.venv/bin/python scripts/generate_valid_xmind.py \
  <CourseName>/<file>_clean.mm \
    <CourseName>/<file>_fixed.xmind \
    [<CourseName>/<CourseName>_GoodNotes_detailed.md]
```
